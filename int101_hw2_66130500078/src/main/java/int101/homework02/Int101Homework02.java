...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println("computeIsbn10(943539432) returns " + computeIsbn10(943539432));
       /*
    ...
    static void work02Person() {
        ...
        System.out.println("Created a person: " + person1);
    ...
    static void work03Account() {
        ...
        System.out.println("account2.toString() : " + account2);
    }
}
